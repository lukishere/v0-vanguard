...
const STATUS_OPTIONS: DemoStatus[] = ["active", "in-development", "available", "expired"]
        ...
        <div className="space-y-4 py-2">
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-white/40">Debe ser único. Usarlo para relacionar accesos y reportes.</p>
            </div>
            <div className="space-y-2">
