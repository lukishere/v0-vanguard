...
const translations = {
  en: {
    ...
    "contact.form.captchaRequired": "Please complete the security verification.",
    "contact.form.captchaError": "Security verification failed. Please try again.",
    "contact.form.captchaUnavailable": "Security verification is currently unavailable.",
    "contact.form.privacy": "Your information is secure and will only be used to contact you.",
  ...
  es: {
    ...
    "hero.subtitle": "Servicios especializados en Agentes de IA, Automatizacion, Bots, Servicios Informáticos, Infraestructura y Seguridad",
    ...
    "contact.form.captchaRequired": "Por favor, completa la verificación de seguridad.",
    "contact.form.captchaError": "La verificación de seguridad falló. Por favor, inténtalo de nuevo.",
    "contact.form.captchaUnavailable": "La verificación de seguridad no está disponible actualmente.",
    "contact.form.privacy": "Tu información está segura y solo se utilizará para contactarte.",
    ...
    "reviews.client1.review": "VANGUARD-IA's AI implementation transformed our data processing capabilities. We've seen a 40% increase in efficiency and significant cost reduction in just three months.",
    ...
    "reviews.client2.review": "The security infrastructure VANGUARD-IA designed for us has proven robust against multiple threat vectors. Their ongoing support and proactive monitoring have been invaluable.",
    "reviews.client3.name": "Carlos Mendoza",
    "reviews.client3.position": "Marketing Director",
    "reviews.client3.company": "HealthPlus Systems",
    "reviews.client3.review": "Our web presence has completely transformed since working with VANGUARD-IA. The branding strategy they developed perfectly captures our mission and has resonated strongly with our target audience.",
  },
  es: {
    "nav.home": "Inicio",
    "nav.about": "Nosotros",
    ...
    "footer.description": "Artesanos de la tecnología dedicados a la innovación",
    ...
    "reviews.client1.position": "CTO",
    "reviews.client1.company": "TechNova Solutions",
    "reviews.client1.review": "La implementación de IA de VANGUARD-IA transformó nuestras capacidades de procesamiento de datos. Hemos visto un aumento del 40% en eficiencia y una reducción significativa de costos en solo tres meses.",
    "reviews.client2.name": "Elena Rodríguez",
    "reviews.client2.position": "Directora de Seguridad",
    "reviews.client2.company": "Global Financial Group",
    "reviews.client2.review": "La infraestructura de seguridad que VANGUARD-IA diseñó para nosotros ha demostrado ser robusta contra múltiples vectores de amenazas. Su soporte continuo y monitoreo proactivo han sido invaluables.",
    "reviews.client3.name": "Carlos Mendoza",
    "reviews.client3.position": "Director de Marketing",
    "reviews.client3.company": "HealthPlus Systems",
    "reviews.client3.review": "Nuestra presencia web se ha transformado completamente desde que trabajamos con VANGUARD-IA. La estrategia de marca que desarrollaron captura perfectamente nuestra misión y ha resonado fuertemente con nuestra audiencia objetivo.",
  }
} as const
