...
export function AdminLayoutClient({ children }: AdminLayoutClientProps) {
  ...
  useEffect(() => {
    ...
    if (!hasAdminRole) {
      ...
      console.log(
        "  💡 To grant admin access, run: pnpm tsx scripts/make-admin.ts",
        user.id
      );
        ...
        <div className="flex flex-1 flex-col">
          <header className="sticky top-0 z-40 flex items-center justify-between border-b border-white/20 admin-bg-secondary px-8 py-6 backdrop-blur-xl">
            <div className="space-y-1">
              <p className="text-xs uppercase tracking-[0.4em] text-white/60 font-medium">
            ...
            <div className="flex items-center gap-6">
              <div className="text-right space-y-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs text-admin-success-400 font-medium">
                    Rol: Administrador
                  </p>
                </div>
              </div>
